...
export function generateInstallationUrl(state?: string): string {
  ...
  const params = new URLSearchParams({
    ...
    response_type: 'code',
    scope: 'conversations/message.readonly locations.readonly users.readonly contacts.readonly contacts.write conversations.readonly conversations/message.write',
    state: oauthState
  });
